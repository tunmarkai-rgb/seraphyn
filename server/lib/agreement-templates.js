const AGREEMENT_TEMPLATES = {
  direct_hire: {
    ...
    intro:
      'This agreement governs direct-hire recruiting and placement services between Seraphyn Care Solutions and the employer organization.',
    sections: [
      {
    ...
    acknowledgements: [
      'I confirm that my organization is engaging Seraphyn for direct-hire recruiting support.',
      'I confirm that I am authorized to sign this agreement on behalf of the employer.',
      'I acknowledge that candidate information provided by Seraphyn will be handled confidentially.'
    ],
    requiredFields: [
      'organizationName',
      'organizationType',
  ...
  staffing_boss: {
    ...
    acknowledgements: [
      ...
      'I understand that my organization is responsible for onsite supervision, scheduling, and time confirmation.',
      'I confirm that I am authorized to sign this agreement on behalf of the employer.'
    ],
    requiredFields: [
      'organizationName',
